      ...
      desktop = [
        ...
        ({pkgs, ...}: {
          ...
          sops = {
            ...
            # Deliberate exceptions to the no-ambient-secrets rule: this tooling
            # is used interactively here and wants its API keys in the env.
            userSecrets.exportToShell = [
              "databento/api_key"
